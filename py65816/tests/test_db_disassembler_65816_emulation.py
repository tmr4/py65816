...
class DisassemblerTests(unittest.TestCase):
    ...
    def test_disassembles_89(self):
        length, disasm = self.disassemble([0x89, 0xab])
        self.assertEqual(2, length)
        self.assertEqual('BIT #$ab', disasm)
    ...
    def test_disassembles_c2(self):
        ...
        self.assertEqual(2, length)
        self.assertEqual('REP #$ff', disasm)
    ...
    def test_disassembles_e2(self):
        ...
        self.assertEqual(2, length)
        self.assertEqual('SEP #$ff', disasm)
    ...
    def disassemble(self, bytes, pc=0, mpu=None):
        if mpu is None:
            mpu = MPU() # we're in emulation mode
